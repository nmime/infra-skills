...
│  ✓ DO:    Wait for quality setups                          │
│                                                             │
│  ✗ DON'T: Bet big on single coin                           │
│  ✓ DO:    Spread across 3-4 positions                      │
│                                                             │
│  ✗ DON'T: Fight the trend                                  │
│  ✓ DO:    Trade WITH the trend only                        │
│                                                             │
│  ✗ DON'T: Hold losers hoping                               │
│  ✓ DO:    Cut losses fast, let winners run                 │
│                                                             │
...
│         │                   │                   │          │
│         ▼                   ▼                   ▼          │
│  • Schedule (2hr)     • Trend check       • 3-7x lever     │
│  • Event fires        • 3+ confirmations  • Bracket order  │
│                       • Confidence 7+     • Diversify      │
│                       • Skip if unclear   • Tight stops    │
│                                                             │
│  ┌──────────────────────────────────────────────────────┐  │
│  │              ENTRY REQUIREMENTS (all must pass)       │  │
│  │                                                        │  │
│  │  1. TREND:    Clear direction on higher timeframe     │  │
│  │  2. MOMENTUM: Price moving with trend, not against    │  │
│  │  3. FUNDING:  Not extreme against position            │  │
│  │  4. CONFIDENCE: 7+ out of 10                          │  │
│  │                                                        │  │
│  │  If any fails → SKIP, wait for next scan              │  │
│  └──────────────────────────────────────────────────────┘  │
│                                                             │
│  ┌──────────────────────────────────────────────────────┐  │
│  │              PORTFOLIO MANAGEMENT                     │  │
│  │  • Max 4 positions at once                           │  │
│  │  • No more than 2 positions same direction           │  │
│  │  • Spread across different coins                     │  │
│  │  • Rebalance if one position dominates               │  │
│  └──────────────────────────────────────────────────────┘  │
│                                                             │
│  ┌──────────────────────────────────────────────────────┐  │
│  │              TARGET CHECK (after each trade)          │  │
│  │  • If balance >= target → STOP, celebrate 🎯          │  │
│  │  • If balance < target → Continue loop                │  │
│  └──────────────────────────────────────────────────────┘  │
│                                                             │
└─────────────────────────────────────────────────────────────┘
```
